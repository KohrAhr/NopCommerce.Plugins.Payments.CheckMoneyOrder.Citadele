...
namespace Nop.Plugin.Payments.CheckMoneyOrder.Citadele
{
    /// <summary>
    ...
    public class CheckMoneyOrderPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        private readonly CheckMoneyOrderCitadelePaymentSettings _checkMoneyOrderPaymentSettings;
        ...
        public CheckMoneyOrderPaymentProcessor(CheckMoneyOrderCitadelePaymentSettings checkMoneyOrderPaymentSettings,
        ...
        {
            return $"{_webHelper.GetStoreLocation()}Admin/PaymentCheckMoneyOrderCitadele/Configure";
        }
        ...
        {
            return "CheckMoneyOrder.Citadele";
        }
        ...
        {
            //settings
            var settings = new CheckMoneyOrderCitadelePaymentSettings
            {
            ...
            await _localizationService.AddOrUpdateLocaleResourceAsync(new Dictionary<string, string>
            {
                ...
                ["Plugins.Payment.CheckMoneyOrder.PaymentMethodDescription"] = "Pay by make wire transfer to bank account",
        ...
        {
            //settings
            await _settingService.DeleteSettingAsync<CheckMoneyOrderCitadelePaymentSettings>();

            //locales
            await _localizationService.DeleteLocaleResourcesAsync("Plugins.Payment.CheckMoneyOrder.Citadele");
