...
using Nop.Core;
using Nop.Plugin.Payments.CheckMoneyOrder.Citadele.Models;
...
namespace Nop.Plugin.Payments.CheckMoneyOrder.Citadele.Controllers
{
    [AuthorizeAdmin]
    [Area(AreaNames.Admin)]
    [AutoValidateAntiforgeryToken]
    public class PaymentCheckMoneyOrderCitadeleController : BasePaymentController
    {
        #region Fields
        ...
        public PaymentCheckMoneyOrderCitadeleController(ILanguageService languageService,
        ...
        public async Task<IActionResult> Configure()
        {
            ...
            var checkMoneyOrderPaymentSettings = await _settingService.LoadSettingAsync<CheckMoneyOrderCitadelePaymentSettings>(storeScope);
            ...
            return View("~/Plugins/Payments.CheckMoneyOrder.Citadele/Views/Configure.cshtml", model);
        }
